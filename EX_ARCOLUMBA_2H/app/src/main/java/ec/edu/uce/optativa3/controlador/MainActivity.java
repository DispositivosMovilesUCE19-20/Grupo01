    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnEntrar:
                ...
                // para mostrar las notificaciones al iniciar sesion



                //Intent intent = new Intent(this, RegistroUsuario.class); // cambiat si se desea que al precionar la notificacion se abra una actividad
