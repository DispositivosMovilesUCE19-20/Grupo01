...
public class DataAdapter extends RecyclerView.Adapter<DataAdapter.ViewHolderData> {
    ...
    public DataAdapter(List<Estudiante> estudiantes, Context context) {
    ...
    public void onBindViewHolder(ViewHolderData holder, int position) {
        ...
        holder.user.setText(estudiantes.get(position).getUsuario());
        holder.mail.setText(estudiantes.get(position).getCorreo());
        holder.celular.setText(estudiantes.get(position).getCelular());
